...
export default function V2Nav({ currentPage, variant = "light" }: V2NavProps) {
  ...
  return (
    ...
    >
    <nav
      className={`flex justify-between items-center font-mono-ui text-xs tracking-wide ${
        isDark ? "text-neutral-400" : "text-neutral-600"
      }`}
      style={{ padding: "12px 48px", maxWidth: "1300px", margin: "0 auto" }}
    >
      <div className="flex items-center">
        {/* DC Logo — sits in column 0 area */}
        <div className="flex items-center gap-3" style={{ width: 174, flexShrink: 0 }}>
          <a
            href="/v2"
